...
```
cd existing_repo
git remote add origin https://gitlab.cecs.pdx.edu/lishih/23spring-410p-endless-spire.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cecs.pdx.edu/lishih/23spring-410p-endless-spire/-/settings/integrations)
